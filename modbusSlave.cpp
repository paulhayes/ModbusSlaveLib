...
*/
void modbusSlave::setBaud(HardwareSerial* SerialPort, word baud,unsigned char byteFormat,unsigned char _TxEnablePin=255)
{
	_baud = baud;
...
/*void modbusSlave::calcCrc(void)
{
  ...
  for (int pos = len-1; pos >= 0; pos--) {
    crc ^= (word)_msg[pos];          // XOR byte into least sig. byte of crc
